function output = main_GUI_obs_check(handles)
...
un_set_index = find(~handles.generate_control_file_button_state(15:19),1,'first');
if(~isempty(un_set_index))
    if(un_set_index >= 1 && un_set_index <= 4)
        ...
        msg = ['存储控制->监控点->开始记录时间->','“',state_lis_cn{un_set_index-14},'”','未设置或设置有误，请前往设置！'];
